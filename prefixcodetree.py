...
class PrefixCodeTree:
    ...
    def decode(self, encodedData, datalen): # duyệt cây
        
        binary_str = int.from_bytes(encodedData, byteorder='big')
        #print(bin(binary_str)[2:2+datalen])
        
        
        encodedData = str(bin(binary_str)[2:2+datalen])
...
trie.insert("101","x3")
trie.insert("11","x4")
print(trie.decode( b'\xd2\x9f\x20', 21))